...
const Footer = () => {
  ...
  return (
    <footer className="relative z-20 border-t-2 border-cyber-teal bg-neutral-light text-neutral-900 dark:bg-neutral-dark dark:text-silver-grey">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6 md:col-span-2">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-ubuntu font-semibold text-2xl text-neutral-900 dark:text-white">
                MerchantHaus
              </h3>
            </div>
            <p className="font-montserrat text-base text-neutral-700 dark:text-silver-grey/90 max-w-md leading-relaxed">
              Empowering merchants and ISOs through tailored retail solutions for payment processing.
            </p>
            <div className="space-y-3 font-montserrat text-base text-neutral-700 dark:text-silver-grey">
              <div>
                <span className="text-neutral-900 font-semibold dark:text-white">Phone:</span>{" "}
                <a href="tel:+15056006042" className="text-cyber-teal hover:underline">
                  1-505-600-6042
                </a>
              </div>
              <div>
                <span className="text-neutral-900 font-semibold dark:text-white">Email:</span>{" "}
                <button
              ...
              <div className="text-neutral-600 dark:text-silver-grey/80 text-sm">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-ubuntu font-semibold text-lg text-neutral-900 dark:text-white mb-6">Quick Links</h4>
            <ul className="space-y-3 font-montserrat text-base text-neutral-700 dark:text-silver-grey">
              <li>
          ...
          {/* Resources & Social */}
          <div>
            <h4 className="font-ubuntu font-semibold text-lg text-neutral-900 dark:text-white mb-6">Resources</h4>
            <ul className="space-y-3 font-montserrat text-base mb-8 text-neutral-700 dark:text-silver-grey">
              <li>
            ...
            <h4 className="font-ubuntu font-semibold text-lg text-neutral-900 dark:text-white mb-6">Follow Us</h4>
            <ul className="space-y-3 font-montserrat text-base text-neutral-700 dark:text-silver-grey">
              <li>
        ...
        {/* Trust Seals Section */}
        <div className="py-8 border-t border-neutral-200 dark:border-white/10">
          <h4 className="font-ubuntu font-semibold text-lg text-neutral-900 dark:text-white text-center mb-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <div className="flex flex-col items-center group">
              ...
              />
              <span className="text-xs text-neutral-700 dark:text-silver-grey mt-2">PCI DSS Compliant</span>
            </div>
            <div className="flex flex-col items-center group">
              <img
                ...
                className="h-20 w-20 object-contain transition-transform group-hover:scale-110"
              />
              <span className="text-xs text-neutral-700 dark:text-silver-grey mt-2">256-bit SSL</span>
            </div>
            <div className="flex flex-col items-center group">
              <img
                ...
                className="h-20 w-20 object-contain transition-transform group-hover:scale-110"
              />
              <span className="text-xs text-neutral-700 dark:text-silver-grey mt-2">Bank-Level Security</span>
            </div>
            <div className="flex flex-col items-center group">
              <img
                ...
                className="h-20 w-20 object-contain transition-transform group-hover:scale-110"
              />
              <span className="text-xs text-neutral-700 dark:text-silver-grey mt-2">24/7 Support</span>
            </div>
            <div className="flex flex-col items-center group">
              <img
                src="/logos/visa.webp" 
        ...
        {/* Bottom Line */}
        <div className="pt-8 border-t border-neutral-200 dark:border-white/10 text-center font-montserrat text-sm text-neutral-700 dark:text-silver-grey">
          <p>
